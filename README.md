...
- 🧠 Interesse em APIs, banco de dados, arquitetura de software e interfaces modernas
- 📚 Sempre buscando evoluir tecnicamente através de projetos práticos
- 🛠️ Experiência com aplicações completas, do front-end ao back-end
...
<img src="https://skillicons.dev/icons?i=tailwind,angular,java,spring,postgres,mysql,figma,typescript,javascript,html,css,git,github,vscode,docker" />
